...
\noindent\textbf{Exercise~\ref{ex:connections-1}.}\label{sol:connections-1}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:connections-2}.}\label{sol:connections-2}

Recall that the transformation law is
\bse
