...
\noindent\textbf{Exercise~\ref{ex:cosmology-1}.}\label{sol:cosmology-1}

If you have done the exercise in the notes to show
\bse
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:cosmology-2}.}\label{sol:cosmology-2}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:cosmology-3}.}\label{sol:cosmology-3}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:cosmology-4}.}\label{sol:cosmology-4}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:cosmology-5}.}\label{sol:cosmology-5}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:cosmology-6}.}\label{sol:cosmology-6}
