...
\noindent\textbf{Exercise~\ref{ex:diagrams-1}.}\label{sol:diagrams-1}

A spatially flat FRW universe has $\kappa=0$ and a metric with components
\bse
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:diagrams-2}.}\label{sol:diagrams-2}

Solving the differential equation from the previous question gives us
\bse
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:diagrams-3}.}\label{sol:diagrams-3}

We can rearrange the expression for $t_{\pm}$ in terms of $r$ to give
\bse
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:diagrams-4}.}\label{sol:diagrams-4}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:diagrams-5}.}\label{sol:diagrams-5}
...
\bigskip
\noindent\textbf{Exercise~\ref{ex:diagrams-6}.}\label{sol:diagrams-6}
