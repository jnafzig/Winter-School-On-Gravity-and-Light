...
\section{\texorpdfstring{New Structure on $(\cM,\cO,\cA)$ Required to Fix $\nabla$}{New Structure on (M,O,A) Required to Fix nabla}}
...
\section{\texorpdfstring{Change of $\Gamma$s Under Change of Chart}{Change of Gammas Under Change of Chart}}
