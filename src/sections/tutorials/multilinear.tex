...
\subsection{The Vector Space of Homomorphisms}

\begin{exercise}\label{ex:multilinear-15}
Let $(V,+,\cdot)$ and $(W,+,\cdot)$ be vector spaces. Define the map $\mathbf{0}: V \to W$ by $\mathbf{0}(v) := 0_W$ for all $v\in V$, where $0_W$ is the neutral element of $W$. Show that $\mathbf{0} \in \Hom(V,W)$ and that it is the neutral element of $(\Hom(V,W),\oplus,\odot)$.
\end{exercise}
\hyperref[sol:multilinear-15]{\small \textit{Solution on p.~\pageref*{sol:multilinear-15}}}

\begin{exercise}\label{ex:multilinear-16}
Let $\varphi \in \Hom(V,W)$. Define the map $\widetilde{\varphi}: V \to W$ by $\widetilde{\varphi}(v) := -\varphi(v)$ for all $v\in V$, where $-\varphi(v)$ denotes the additive inverse of $\varphi(v)$ in $W$. Show that $\widetilde{\varphi} \in \Hom(V,W)$ and that it is the inverse of $\varphi$ w.r.t. $\oplus$.
\end{exercise}
\hyperref[sol:multilinear-16]{\small \textit{Solution on p.~\pageref*{sol:multilinear-16}}}
